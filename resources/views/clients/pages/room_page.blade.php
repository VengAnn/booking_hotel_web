            ...
            <div class="row">
                ...
                <aside class="col-lg-3 mb-4">
                    <div class="bg-light p-3 rounded shadow-sm">
                        <h6 class="fw-bold mb-3"><i class="fas fa-search me-1 text-primary"></i> Tìm kiếm phòng</h6>
                        ...
                        <h6 class="fw-bold mt-3 mb-2"><i class="fas fa-filter me-1 text-secondary"></i> Tiện nghi</h6>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="filterWifi">
                            <label class="form-check-label" for="filterWifi"><i class="fas fa-wifi me-1"></i> Wifi miễn
                                phí</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="filterTv">
                            <label class="form-check-label" for="filterTv"><i class="fas fa-tv me-1"></i> Tivi</label>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="filterAc">
                            <label class="form-check-label" for="filterAc"><i class="fas fa-snowflake me-1"></i> Điều
                                hòa</label>
                        </div>

                        <button class="btn btn-primary w-100" id="btnSearch"><i class="fas fa-search me-1"></i> Tìm
                            kiếm</button>
                    </div>
                </aside>
